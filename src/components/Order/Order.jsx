  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 md:py-12 space-y-8">
          ...
          {paymentOptions.map((option) => (
            <div
              ...
              className={`border rounded-2xl p-4 cursor-pointer flex flex-col items-center transition hover:shadow-lg ${
                paymentMethod === option.id ? "border-red-500 bg-red-50" : "border-gray-300"
              }`}
              onClick={() => setPaymentMethod(option.id)}
            >
              <div className="text-red-500 mb-2">{option.icon}</div>
      ...
      <div className="bg-white p-4 md:p-6 rounded-2xl shadow-lg space-y-3 border border-gray-200">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          <input
            ...
            className="flex-1 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 transition"
          />
          <button
            onClick={applyCoupon}
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-red-500 to-pink-500 text-white font-bold py-4 rounded-2xl hover:from-red-600 hover:to-pink-600 transition text-lg"
      >
        COMPLETE ORDER
      </button>
    </div>
